      ...
      <div style={{ position: 'relative', zIndex: 10, padding: '6rem 2rem', maxWidth: '900px', margin: '0 auto' }}>
        ...
        >
          <div>
            ...
            <p style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '1rem' }}>Full Stack Developer • AI & Automation • Content Creator • Video Editor • Trader</p>
          </div>
          <motion.a 
        ...
        >
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem', flexWrap: 'wrap', gap: '0.5rem' }}>
              <span style={{ fontWeight: 600, fontSize: '0.95rem', color: '#fff' }}>Full Time Trader</span>
              <span style={{ color: 'rgba(255, 255, 255, 0.4)', fontSize: '0.85rem' }}>2025 - 2026</span>
            </div>
            <p style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '0.9rem' }}>Day trading in financial markets with a focus on strategic analysis and risk management.</p>
          </div>

          <div style={{ marginBottom: '1.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem', flexWrap: 'wrap', gap: '0.5rem' }}>
              <span style={{ fontWeight: 600, fontSize: '0.95rem', color: '#fff' }}>Social Media Manager / Content Creator</span>
              <span style={{ color: 'rgba(255, 255, 255, 0.4)', fontSize: '0.85rem' }}>2024 - 2026</span>
            </div>
            <p style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '0.9rem' }}>Managing social media presence and creating engaging content for various clients.</p>
          </div>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <p style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '0.9rem' }}>Video editing for international clients. Mastery in After Effects, CapCut, Premiere Pro, Da Vinci Resolve, Filmora.</p>
          </div>

          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem', flexWrap: 'wrap', gap: '0.5rem' }}>
              <span style={{ fontWeight: 600, fontSize: '0.95rem', color: '#fff' }}>Web Developer / Full Stack Developer (Freelancer)</span>
              <span style={{ color: 'rgba(255, 255, 255, 0.4)', fontSize: '0.85rem' }}>2019 - 2026</span>
            </div>
        ...
        >
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
            {['JavaScript', 'TypeScript', 'React', 'Next.js', 'Node.js', 'Python', 'AI Tools', 'Video Editing', 'After Effects', 'Premiere Pro', 'Da Vinci Resolve', 'Content Creation', 'Streaming', 'Trading', 'Problem Solving'].map((skill) => (
              <span 
                key={skill}
                style={{ 
                  padding: '0.5rem 1rem', 
        ...
        >
          ...
          <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.9rem', lineHeight: 2 }}>
            <span style={{ color: 'rgba(255, 255, 255, 0.5)' }}>Location:</span> Flat no. 002, A-24, May Flower, Shristi Hills CHS, Jhambul – MIDC road, Ambernath – W, 421505<br/>
            <span style={{ color: 'rgba(255, 255, 255, 0.5)' }}>Phone:</span> +91 9322309947<br/>
            <span style={{ color: 'rgba(255, 255, 255, 0.5)' }}>Email:</span> contact.unfiltered.anshul@gmail.com<br/>
            <span style={{ color: 'rgba(255, 255, 255, 0.5)' }}>Date of Birth:</span> 09/11/2003<br/>
